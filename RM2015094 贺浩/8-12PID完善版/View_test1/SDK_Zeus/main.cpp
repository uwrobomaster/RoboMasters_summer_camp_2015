...
//extern float Mag_Sampling;
Rho_PID Rho;
Theta_PID Theta;
X_Offset_PID X_Offset;
Yaw_Spin_PID Yaw_Spin;
extern float SpeedZ_out,Rate_YAW_out,SpeedY_out,SpeedX_out,Yaw_Spin_out;
void parameterSet();
int initPlane();
...
//    sprintf(filename5,"%s%s.txt","Mag_Sampling",filename);
...
//    ofstream file_Mag_Sampling(filename5,ios::out);
...
//       file_Mag_Sampling<<Mag_Sampling<<' '<<endl;
